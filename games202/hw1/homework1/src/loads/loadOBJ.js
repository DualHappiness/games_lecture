				...
				.load(name + '.obj', function (object) {
					object.traverse(function (child) {
						if (child.isMesh) {
							...
							let lights = renderer.lights.map(l => l.entity);
							switch (objMaterial) {
								case 'PhongMaterial':
									...
									shadowMaterials = lights.map(light => buildShadowMaterial(light, Translation, Scale, "./src/shaders/shadowShader/shadowVertex.glsl", "./src/shaders/shadowShader/shadowFragment.glsl"));
									break;
							}
							...
							shadowMaterials.forEach((mat) => mat.then((data) => {
